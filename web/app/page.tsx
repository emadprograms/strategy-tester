...
import { Database, UploadCloud, TrendingUp, Search, Calendar, ChevronRight, Activity, Zap, CheckCircle2, AlertCircle, BarChart3, LineChart, FileTerminal, ChevronLeft, Menu, LayoutDashboard, PlusCircle } from "lucide-react";
          ...
          {activeTab === "logger" && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-8">
              ...
              <div className="flex flex-col md:flex-row gap-6 justify-between items-end">
                <div>
                  <h1 className="text-3xl font-semibold tracking-tight text-white mb-2">Log a New Trade</h1>
                  <p className="text-sm text-gray-400">Record your setup and outcomes. Use auto-fill to pull context from your local archive.</p>
                </div>
                <button 
